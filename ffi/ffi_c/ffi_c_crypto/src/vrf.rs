...
pub extern "C" fn wedpr_curve25519_vrf_prove_utf8(
    ...
    let result = panic::catch_unwind(|| {
        ...
        let proof = match WedprCurve25519Vrf::prove(&private_key, &message) {
            Ok(v) => v,
            Err(_) => {
                return ptr::null_mut();
            },
...
pub extern "C" fn wedpr_curve25519_vrf_prove_fast_utf8(
    encoded_private_key: *const c_char,
...
pub extern "C" fn wedpr_curve25519_vrf_verify_utf8(
    encoded_public_key: *const c_char,
    utf8_message: *const c_char,
...
pub extern "C" fn wedpr_curve25519_vrf_proof_to_hash(
    encoded_proof: *const c_char,
) -> *mut c_char {
    let result = panic::catch_unwind(|| {
