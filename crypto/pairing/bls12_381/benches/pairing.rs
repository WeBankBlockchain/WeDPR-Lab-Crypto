...
//
// Benchmarking create_equality_test_true_helper: Collecting 100 samples in
// estimated 5.0818
// create_equality_test_true_helper time:   [3.6239 ms 3.6720 ms 3.7206 ms]
// change: [-0.7217% +0.7001% +2.2908%] (p = 0.38 > 0.05)
// No change in performance detected.
//
// Benchmarking create_equality_test_false_helper: Collecting 100 samples in
// estimated 5.068
// create_equality_test_false_helper time:   [3.6027 ms 3.6737 ms 3.7520 ms]
